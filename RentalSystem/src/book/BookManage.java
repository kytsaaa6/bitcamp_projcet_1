...
public class BookManage implements BookManagement {
	...
	private ArrayList<BookInfo> book; // 책 목록 배열
	private ArrayList<BookInfo> searchResult; // 검색결과 배열
	...
	public ArrayList<BookInfo> getSearchResult(){
		return searchResult;
	}
	
	//싱글톤 추가
	private BookManage() {
		book = new ArrayList<BookInfo>(35); // 책 목록 배열
		searchResult = new ArrayList<BookInfo>(); // 검색결과 배열
	}
	
	private static BookManage m = new BookManage();
